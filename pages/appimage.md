...
| 📀   | [Readest](https://readest.com) | A cross-platform ebook reader | Um leitor de ebook multiplataforma |
...
| 📦    | [Pandoc](https://github.com/jgm/pandoc)                              | Universal markup converter                                               | Conversor universal de linguagens de marcação                                      |
...
| 📀 | [GM Companion](https://gm-companion.github.io/) | A free and open-source tool for tabletop rpg gamemasters. | Uma ferramenta livre e grauita para mestres de RPG de mesa|
...
| 📀 | [Rolistream](https://rolisteam.org/) | A virtual tabletop software | Um tabuleiro de RPG virtual |
...
| 📀1️⃣ | [Speek](https://speek.network/)                   | Decentralized and secure messenger                                                                             | Mensageiro descentralizado e seguro                  |
...
| 💿    | [Tut](https://github.com/RasmusLindroth/tut)      | TUI for Mastodon with vim inspired keys                                                                        | Interface em texto para Mastodon                     |
...
| Tags  | App                                                  | Description                                                                                                                          | PT-BR                                                                        |
| ----- | ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------- |
| 📦 | [Algernon](https://algernon.roboticoverlords.org/) | Web server with built-in support for Markdown, Sass(SCSS), BoltDB PostgreSQL, MariaDB/MySQL, users, permissions and more | Servidor web com suporte incluído a Markdown, SCSS, BoltDB, PostgreSQL, MariaDB/MySQL, usuários, permissões e mais |
| 📦 | [Basilisk](https://www.basilisk-browser.org/) | A XUL-based web-browser built on top of the Unified XUL Platform | Um navegador web construído no topo da plataforma XUL |
...
| 📦 | [Ghostery](https://www.ghostery.com/ghostery-private-browser-linux) | Browse the web safer, faster & with less ads | Navegador para uma web mais segura, rápida e com menos publicidade |
| 📦 | [Icecat](https://www.gnu.org/software/gnuzilla/) | GNU IceCat is the GNU version of the Firefox browser | GNU Icecat é a versão GNU do navegador Firefox |
...
| 📀 | [Midori](https://astian.org/midori-browser-desktop/) | A fast and secure lightweight browser available for your desktop computer | Um navegador rápido e seguro disponível para seu computador desktop |
...
| 📦1️⃣    | [Pulse Browser](https://pulsebrowser.app/)           | An experimental Firefox fork that enhances focus and increases work productivity due to its hyper minimalistic UI and built-in tools | Fork do Firefox para foco e produtividade                                    |
...
| 📀 | [Station](https://getstation.com/) | The first open-source smart browser for busy people | O primiero navegador inteligente de código aberto para pessoas ocupadas |
...
| 💿    | [Youtube-DL](https://github.com/ytdl-org/youtube-dl) | Command-line program to download videos from YouTube.com and other video sites                                                       | Comando para baixar vídeos do Youtube e outros                               |
...
| 📀 | [Helix](https://helix-editor.com/) | A post-modern text editor | Um editor de textos pós-moderno |
