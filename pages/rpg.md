...
| ---- | --------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| - | [DDDice](https://dddice.com/) | A multiplayer dice roller that allows you to roll, create, and collect 3D dice with your party or community | Um rolador de dados multiplayer que lhe permite rolar, criar e coletar dados 3D com seu grupo ou comunidade |
...
| - | [Major's 3D Dice](http://dnd.majorsplace.com/dice/) | System for offline or shared dice rolliing | Sistema para rolagem de dados offline ou compartilhada |
| -    | [MasterScreen](https://masterscreen.app/) | The ultimate set of tools for running tabletop or online roleplay campaigns and managing intricate fictional worlds. | O conjunto final de ferramentas para executar campanhas de mesa ou de roleplay online e gerenciar mundos fictícios intrincados. |
| -    | [Printable Heroes](https://printableheroes.com) | Creates print-ready miniatures (or minis) for D&D or other TTRPG | Cria miniaturas prontas para impressão para D&D e outros RPGs de mesa |
...
| 📑🇧🇷 | [Bazar Verde](https://bazarverde.com.br) | In Portuguese | Acervo de material independente, brasileiro |
...
| 📑🇺🇸 | [Games](https://sillyhatbooks.com/other-stuff/games/) | The Compendium of Free Tabletop Role Playing Games | O Compêndio de Jogos de RPG de Mesa Grátis |
...
| Tags | Link                                                                                        | Description                                                                                                                               | PT-BR                                               |
| ---- | ------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| -    | [Avatar Maker](https://avatarmaker.com)                                                     | Create your own avatar online                                                                                                             | -                                                   |
...
| -    | [DM Heroes](http://dmheroes.com)                                                            | Creating tools, content, and art for D&D                                                                                                  | Gerador de imagem de personagem para D&D            |
| -   | [Dressing Room](https://www.wowhead.com/dressing-room) | Try out armor sets on any World of Warcraft character | Experimente conjuntos de armaduras em qualquer personagem do World of Warcraft |
| -    | [DunGen](https://dungen.app/dungen/)                                                        | Dungeon Generator                                                                                                                         | Gerador de dungeon                                  |
| - | [Dungeonfog](https://www.dungeonfog.com/) | TTRPG Map Editor | Editor de mapas para RPG |
| - | [Dungeon Map Dooder](https://dungeonmapdoodler.com/draw/#) | A program designed to easily create tabletop RPG maps created by Todd Ross | Um programa projetado para criação facilitada de mapas de RPG de mesa, criado por Todd Ross |
| - | [Dungeon Scrawl](https://www.dungeonscrawl.com/) | Old-School Dungeon Maps Made Easy | Crie mapas old-schools facilmente |
...
| -    | [Hexfriend](https://hexfriend.net) | Hexagonal map editor | Editor de mapas hexagonais |
| -    | [Hexographer](http://www.hexographer.com/) |  Hexographer lets you make a map in a tenth of the time it takes just to learn another tool | Hexographer permite fazer um mapa em um décimo do tempo necessário apenas para aprender outra ferramenta |
| -    | [HexRoll](https://hexroll.app) | a sandbox generator designed to randomize skeletal content for tabletop role-playing games | Gerador de caixa de areia projetado para aleatorizar conteúdo para RPG |
...
| - | [Inkarnate](https://inkarnate.com/) | An easy-to-use online map-making platform | Uma plataforma online e fácil de usar para criar mapas |
...
| -    | [Nortantis](http://jeheydorn.github.io/nortantis/)                                          | A fantasy map generator that uses a simple tectonic plate simulation to create islands and continents with trees, rivers, and mountains   | Gerador de mapas de fantasia                        |
...
| 🇧🇷   | [2D6World](https://newtonrocha.wordpress.com/2024/03/26/sistema-2d6world-segunda-edicao-regras-narrativista-para-jogos-de-rpg-download-gratuito-nitrogames/) | CC-BY-SA | Only in Portuguese | Derivado do +2D6, compatível com PbtA |
...
| 🇧🇷   | [Old Dragon 2ª Edição](https://linktr.ee/od2)                         | CC-BY-SA     | Only in Portuguese                                     | Linktree                                                       |
...
| 🇧🇷   | [Scop RPG](https://scop.net.br/start)                                                 | CC-BY-SA     | Only in Portuguese                                     | Sistema genérico, livre e aberto, com regras simples, intuitivas e fácil de ser expandido |
